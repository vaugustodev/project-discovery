...
const LogoSvg = () => {
  return (
      <svg data-testid='logo-svg' fill={theme.colors.accent} height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
        viewBox="-267 288.9 264.5 225.1" xmlSpace="preserve">
        <g>
